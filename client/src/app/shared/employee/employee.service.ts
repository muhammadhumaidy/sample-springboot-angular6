...
export class EmployeeService {
  private employeeUrl = '//localhost:8089/api/main/employees';
  private positionUrl = '//localhost:8089/api/main/positions';
  private divisionUrl = '//localhost:8089/api/main/divisions';
  private employeeSequenceUrl = '//localhost:8089/api/main/employee-sequence';
